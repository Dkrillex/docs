...
api: 'POST https://llm.ai-nebula.com/nebula/v4/api/anyShootAdvancedModeSubmit'
---
...
<Tabs>
  <Tab title="cURL示例">
    ```bash
    curl -X POST "https://llm.ai-nebula.com/nebula/v4/api/anyShootAdvancedModeSubmit" \
  ...
  <Tab title="Python示例">
    ...
    url = "https://llm.ai-nebula.com/nebula/v4/api/anyShootAdvancedModeSubmit"
    headers = {
