...
视频生成接口支持文生视频、图生视频等多种功能。通过统一的API接口，您可以调用Sora 2、Veo、阿里万相、豆包 Seedance 等多个主流视频生成模型。
...
<ParamField body="model" type="string" required>
  ...
  - 豆包 Seedance 系列：`doubao-seedance-1-0-pro-250528`、`doubao-seedance-1-0-lite-t2v-250428`、`doubao-seedance-1-0-lite-i2v-250428`、`doubao-seaweed-1-0-t2v-250428`、`wan2-1-14b-i2v-250417`、`wan2-1-14b-flf2v-250417`
</ParamField>
