---
title: "Nebula Lab - 企业级 AI 大模型 API 中转站"
description: "企业级专业稳定的AI大模型API中转站，支持200+热门AI模型"
---

## 欢迎使用 Nebula Lab

**Nebula Lab** 是企业级专业稳定的 AI 大模型 API 中转站，基于统一的 OpenAI API 标准，支持 200+ 热门 AI 模型。一个令牌，即可轻松调用 OpenAI、Claude、Gemini、DeepSeek、Qwen、Kimi、GLM 等所有主流大模型。
...
<Columns cols={2}>
  ...
  <Card title="API 手册" icon="book" href="/cn/api-reference/introduction">
    完整的接口文档和开发者指南
  </Card>
</Columns>
...
<Steps>
  <Step title="注册账号">
    访问 [Nebula Lab](https://ai-nebula.com) 创建您的账号
  </Step>
  <Step title="获取密钥">
    在控制台生成您的 API 密钥
  </Step>
