...
description: 'Seamlessly integrate Nebula Lab using official OpenAI SDKs'
---

## Using Official OpenAI Libraries

Nebula Lab is fully compatible with OpenAI API format. You can use official OpenAI SDKs with just a simple configuration change.
