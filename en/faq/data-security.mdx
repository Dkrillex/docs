...
description: 'Nebula Lab data security measures including encryption, minimal storage, and access control'
---

## Data Security Commitment

Nebula Lab takes user data security seriously with multiple protection measures. We're committed to providing secure, reliable AI services.
...
As a relay platform, Nebula Lab:
...
Nebula Lab conducts regular security assessments:
